...
mysql_select_db($database_rpl, $rpl);
$query_dosen = sprintf("SELECT user_id, name, password FROM `user` WHERE user_id = %s", GetSQLValueString($colname_dosen, "text"));
$dosen = mysql_query($query_dosen, $rpl) or die(mysql_error());
...
<link rel="shortcut iconhttp://twitter.github.com/bootstrap/assets/ico/favicon.ico" />

...
<html lang="en">
  <head>
    ...
    <style>
      ...
      h1.bebas {font: 60px/68px 'BebasNeueRegular', Arial, sans-serif;letter-spacing: 0;}
  ...
  <body>
        ...
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
              ...
              <li><a href="inputkrs.php">Input KRS</a></li>
    ...
    <div class="container">
      ...
      <h1 class="bebas">iKRS Institut Teknologi Indonesia</h1>

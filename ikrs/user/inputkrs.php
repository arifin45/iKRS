<?php
	...
	$cek = mysql_query("SELECT * FROM krs WHERE user_id='$userId' AND semester='$semester' AND tahun='$tahun'");
					...
					<div class="row-fluid" style="padding: 10px;">
						...
						<div class="table">
							<table class="table">
								...
								<?php
									$krs = mysql_query("SELECT a.kode_matkul, a.semester, a.tahun, b.nama_matkul, b.sks FROM krs a LEFT JOIN matakuliah b ON b.kode_matkul = a.kode_matkul WHERE a.user_id='$userId' AND a.semester='$semester' AND a.tahun='$tahun'");
									$jum = 0;
									$i = 1;
